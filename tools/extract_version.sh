...
if [[ "$MACHINE" == "macOS" ]]; then
    SP_INSTALL_PREFIX="/Applications/MNE-Python/${SP_INSTALLER_VERSION}/.mne-python"
    SP_INSTALLER_NAME="MNE-Python-${SP_INSTALLER_VERSION}-${MACHINE}_${MACOS_ARCH}.pkg"
    SP_ACTIVATE="$SP_INSTALL_PREFIX/bin/activate"
elif [[ "$MACHINE" == "Linux" ]]; then
    SP_INSTALL_PREFIX="$HOME/mne-python/${SP_INSTALLER_VERSION}"
    SP_INSTALLER_NAME="MNE-Python-${SP_INSTALLER_VERSION}-${MACHINE}.sh"
    SP_ACTIVATE="$SP_INSTALL_PREFIX/bin/activate"
else
    SP_INSTALL_PREFIX="$HOME/mne-python/$SP_INSTALLER_VERSION"
    SP_INSTALLER_NAME="MNE-Python-${SP_INSTALLER_VERSION}-${MACHINE}.exe"
...
export SP_INSTALLER_ARTIFACT_ID="MNE-Python-${MACHINE}-${ARTIFACT_ID_SUFFIX}"
